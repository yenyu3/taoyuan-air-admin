...
const initialSources: SourceRecord[] = [
  { id: '1', name: '環境部空品監測網', type: 'EPA',   endpoint: 'https://data.epa.gov.tw/api/v2/aqx_p_432',          frequency: 60,  active: true,  lastSync: '2025-01-15 10:30', status: 'success' },
  { id: '2', name: '中央氣象署觀測',   type: 'CWA',   endpoint: 'https://opendata.cwa.gov.tw/api/v1/rest/datastore', frequency: 30,  active: true,  lastSync: '2025-01-15 10:25', status: 'success' },
  { id: '3', name: '光達系統 LiDAR',  type: 'Lidar', endpoint: 'http://lidar.internal/api/data',                    frequency: 120, active: true,  lastSync: '2025-01-15 09:30', status: 'pending' },
  { id: '4', name: '無人機資料系統',   type: 'UAV',   endpoint: 'http://uav.internal/api/upload',                    frequency: 0,   active: false, lastSync: '2025-01-14 15:00', status: 'error'   },
  { id: '5', name: 'IoT 微型感測器',  type: 'IoT',   endpoint: 'https://iot.taoyuan.gov.tw/api',                    frequency: 15,  active: true,  lastSync: '2025-01-15 10:28', status: 'success' },
];
